...
import { History, Activity, Layout, Calendar } from 'lucide-react';
...
export function LifeTimelinePage() {
  useSeo({
    ...
    description:
      'Track your daily journey with the Titan Life Timeline. A unified view of your tasks, notes, and spending in one historical record.',
    path: '/life-timeline',
    breadcrumbs: [
      { name: 'Home', item: '/' },
      { name: 'Features', item: '/features' },
      { name: 'Timeline', item: '/life-timeline' },
    ],
  });
      ...
      <section className="px-6 py-24 text-center sm:px-10">
        <div className="mx-auto max-w-4xl">
          <h1 className="mb-8 text-5xl font-extrabold tracking-tight sm:text-7xl">
            Your Life. <br />
            <span className="text-primary">In Chronology.</span>
          </h1>
          <p className="mb-12 text-lg text-muted-foreground sm:text-xl">
            The Life Timeline is a powerful historical record that unifies your productivity and
            finances into one intuitive daily snapshot.
          </p>
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
          <div className="space-y-8">
            ...
            <p className="text-lg text-muted-foreground">
              Traditional productivity apps show you what to do. Titan shows you what you've{' '}
              <em>done</em> and how it affected your day. By seeing your spending alongside your
              completed tasks, you gain a new level of self-awareness.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'A clean scrollable view of every action you took today.',
                  icon: Activity,
                },
                {
                  title: 'Historical Records',
                  desc: 'Look back weeks or months to identify patterns and growth.',
                  icon: History,
                },
                {
                  title: 'Integrated View',
                  desc: 'Tasks, expenses, and notes side-by-side in real-time.',
                  icon: Layout,
                },
                {
                  title: 'Data Sovereignty',
                  desc: 'Your history is stored locally. No cloud, no tracking.',
                  icon: Calendar,
                },
              ].map((item) => (
      ...
      <section className="bg-card/20 py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground">
            <p className="text-lg">
              Self-improvement requires data. The <strong>Life Timeline</strong> provides the raw
              material for meaningful self-reflection. By seeing your day in chronology, you can ask
              better questions:{' '}
              <em>"Why do my highest expenses happen on my least productive days?"</em> or{' '}
              <em>
                "How does writing a note in the morning affect my task completion in the afternoon?"
              </em>
            </p>
            <p>
              This isn't just a log; it's a mirror for your habits. In Titan, we believe that
              clarity comes from seeing the whole picture—not just the disconnected pieces.
            </p>
          </div>
        </div>
      </section>
