...
import { Button, DatePicker, Dropdown, TagInput } from '@/components/ui';
          ...
          >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Dropdown
                    label="Energy"
                    value={values.energy}
                    onChange={(value) => setValues((current) => ({ ...current, energy: value }))}
                    options={[
                      { label: 'Low', value: 'low' },
                      { label: 'Medium', value: 'medium' },
                      { label: 'High', value: 'high' },
                ...
                <div className="space-y-2">
                  ...
                  <Dropdown
                    label="Area"
                    value={values.area}
                    onChange={(value) => setValues((current) => ({ ...current, area: value }))}
                    options={[
            ...
            <div className="mt-10 flex items-center justify-end gap-3">
              ...
              <Button
                ...
                className="px-8 shadow-glow font-bold uppercase tracking-widest text-[10px]"
              >
                {submitLabel}
              </Button>
            </div>
