...
export const onboardingSteps: OnboardingStepMeta[] = [
  {
    ...
    title: 'Make Titan feel like yours.',
    subtitle: 'No account. No cloud sync. Just local context for a smarter start.',
  },
  {
    id: 'name',
    eyebrow: 'Identity',
  ...
  },
  {
    ...
    subtitle: 'This will be used for all your financial tracking and reports.',
  },
  {
    id: 'phone',
    eyebrow: 'Contact',
    title: 'Phone and UPI',
    subtitle: 'Provide a UPI ID (required for payments); phone number is optional.',
  },
  {
    id: 'dob',
    eyebrow: 'Personalization',
    title: 'Add your date of birth.',
    subtitle: 'Used later for age-aware insights and personal milestones.',
  },
  {
    id: 'income',
    eyebrow: 'Cashflow',
    title: 'Monthly income, roughly.',
    subtitle: 'This becomes the anchor for your first budget suggestions.',
  },
  {
    id: 'expense',
    eyebrow: 'Baseline',
    title: 'Average monthly expense?',
    subtitle: 'Titan uses this as your first spending boundary.',
  },
  {
    id: 'goals',
    eyebrow: 'Intent',
    title: 'Pick what matters now.',
    subtitle: 'Optional, but useful. Choose one or more goals.',
  },
  {
    id: 'preferences',
    eyebrow: 'Defaults',
    title: 'Set your app preferences.',
    subtitle: 'Keep the workspace quiet, fast, and ready for offline use.',
  },
  {
    id: 'ready',
    eyebrow: 'Ready',
    title: 'Your local command center is ready.',
    subtitle: 'Titan will open your dashboard with budget suggestions prepared.',
  },
];
...
export const goalOptions: { id: FinancialGoal; label: string; description: string }[] = [
  {
    id: 'save-money',
    label: 'Save money',
    description: 'Build more room between income and spend.',
  },
  {
    id: 'track-spending',
    label: 'Track spending',
    description: 'See where money actually goes each month.',
  },
  {
    id: 'improve-productivity',
    label: 'Improve productivity',
    description: 'Connect tasks, notes, and focus.',
  },
  {
    id: 'reduce-expenses',
    label: 'Reduce expenses',
    description: 'Start with a tighter monthly boundary.',
  },
];
...
export function normalizeMoneyInput(value: string) {
  ...
  if (numeric.includes('.')) return `${whole}.${decimals}`;
  return whole;
}
...
export function getOnboardingValidationError(
  ...
  if (stepId === 'name' && profile.name.trim().length < 2) return 'Enter at least 2 characters.';
  if (stepId === 'dob' && !isValidDob(profile.dob)) return 'Choose a valid date to continue.';
  if (stepId === 'phone') {
    const upi = (profile.upiId || '').trim();
    if (!upi) return 'Enter a UPI ID to continue.';
    if (!validateUpiId(upi)) return 'Enter a valid UPI ID (e.g., name@bank).';
  }
