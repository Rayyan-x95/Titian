...
const TaskManagerPage = lazy(() => import('@/features/marketing/TaskManagerPage').then((m) => ({ default: m.TaskManagerPage })));
const ExpenseTrackerPage = lazy(() => import('@/features/marketing/ExpenseTrackerPage').then((m) => ({ default: m.ExpenseTrackerPage })));
const SharedExpensesPage = lazy(() => import('@/features/marketing/SharedExpensesPage').then((m) => ({ default: m.SharedExpensesPage })));
const LifeTimelinePage = lazy(() => import('@/features/marketing/LifeTimelinePage').then((m) => ({ default: m.LifeTimelinePage })));
const InstallPage = lazy(() => import('@/features/marketing/InstallPage').then((m) => ({ default: m.InstallPage })));
const BlogPage = lazy(() => import('@/features/marketing/BlogPage').then((m) => ({ default: m.BlogPage })));
const BlogPost = lazy(() => import('@/features/marketing/BlogPost').then((m) => ({ default: m.BlogPost })));

// SEO Specific Landing Pages
const PersonalLifeOSPage = lazy(() => import('@/features/marketing/PersonalLifeOSPage').then((m) => ({ default: m.PersonalLifeOSPage })));
const SplitExpensesAppPage = lazy(() => import('@/features/marketing/SplitExpensesAppPage').then((m) => ({ default: m.SplitExpensesAppPage })));
const WhatIsTitanPage = lazy(() => import('@/features/marketing/WhatIsTitanPage').then((m) => ({ default: m.WhatIsTitanPage })));
const LifeManagementAppPage = lazy(() => import('@/features/marketing/LifeManagementAppPage').then((m) => ({ default: m.LifeManagementAppPage })));
